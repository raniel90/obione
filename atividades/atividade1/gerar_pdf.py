...
def build_pdf():
    ...
    p3 = (
        'Este trabalho propõe o <b>ObiOne</b>, um observatório de projetos potencializado por IA '
        'Generativa que se distingue de ferramentas convencionais de gestão de projetos por '
        'materializar a dimensão de <b>comunidade</b>, característica essencial dos observatórios '
        'segundo o MPO. A pergunta de pesquisa central é: <i>como a IA Generativa pode viabilizar um '
        'observatório-comunidade de projetos, reduzindo a fricção de manutenção e promovendo o '
        'engajamento entre a organização executora e seus clientes?</i> Adotando o <i>Design Science '
        'Research</i> (DSR) como método (Hevner <i>et al.</i>, 2004), o estudo concentra-se em um '
        'ciclo composto por três etapas: (1) consciência do problema, a partir dos <i>gaps</i> '
        'mapeados em Vieira (2022; 2025; 2026), em especial dos Trabalhos Futuros propostos por '
        'Vieira (2022, pp. 215-217) sobre Interatividade em observatórios, estudos comparativos com '
        'outras soluções e desenvolvimento de soluções computacionais à luz do MPO; (2) '
        'desenvolvimento de um observatório que combina <i>pipeline</i> baseado em LLM para extrair '
        'os atributos do Quadro 37 (terceira versão do MPO) de documentos não-estruturados, modelo '
        'de acesso semi-aberto onde a equipe da consultoria curatoriza todos os projetos e cada '
        'cliente acessa apenas o seu, e funcionalidades de comunidade (comentários, perfis, resumos '
        'automáticos para o cliente, drafts assistidos para o consultor) que materializam as '
        'características de Interatividade e Rede de Colaboração do MPO; e (3) avaliação do artefato '
        'mediante estudo de caso com cinco projetos reais de domínios distintos (jurídico, saúde, '
        'esporte e branding), com dupla perspectiva: quantitativa — cobertura do MPO nos cinco '
        'projetos e precisão, <i>recall</i>, F1 e <i>Cohen\'s Kappa</i> contra gabarito manual em '
        'amostra de três projetos — e qualitativa — escala <i>Likert</i> aplicada separadamente à '
        'equipe da consultoria e aos clientes finais.'
    )

    p4 = (
        'Espera-se que o ObiOne demonstre como a IA Generativa pode viabilizar não apenas a coleta '
        'automatizada de dados de projetos a partir de documentos não-estruturados, mas, sobretudo, '
        'a redução da fricção operacional de manter um observatório-comunidade vivo — estendendo a '
        'aplicabilidade do MPO de contextos públicos e acadêmicos para contextos organizacionais '
        'privados multissetoriais, em que a comunidade é formada pela organização executora e seus '
        'clientes.'
    )
