...
export const domainObservatory: Record<string, DomainObservatory> = {
    ...
    observations: [
      {
        id: "o-d1-1",
        type: "fenômeno",
        text: "Fenômeno de instabilidade revisado pela comunidade.",
        actor: "Ana Coelho",
        timeAgo: "há 2 h",
      },
      {
        id: "o-d1-2",
        type: "insight",
        text: "Novo insight gerado a partir do projeto Athos Capital.",
        actor: "ObiOne · IA",
        timeAgo: "há 6 h",
      },
      {
        id: "o-d1-3",
        type: "vínculo",
        text: "Projeto Diagnóstico Vértice concluído e arquivado.",
        actor: "Ana Coelho",
        timeAgo: "há 1 d",
      },
    ],
  ...
  d2: {
    ...
    type: "Híbrido",
    status: "ativo",
    objective: "Acompanhar a expressão simbólica e a coerência criativa das marcas observadas.",
    ...
    observations: [
      {
        id: "o-d2-1",
        type: "fenômeno",
        text: "Novo fenômeno identificado: mudanças de escopo criativo.",
        actor: "ObiOne · IA",
        timeAgo: "há 18 min",
      },
      {
        id: "o-d2-2",
        type: "artefato",
        text: "Artefato analisado em Identidade Visual Norvik.",
        actor: "Lucas Martins",
        timeAgo: "há 3 h",
      },
      {
        id: "o-d2-3",
        type: "discussão",
        text: "Discussão aberta sobre arquitetura simbólica de Korin.",
        actor: "Marina Reis",
        timeAgo: "há 5 h",
      },
      {
        id: "o-d2-4",
        type: "insight",
        text: "Insight 'participação × retrabalho' validado.",
        actor: "Comunidade",
        timeAgo: "há 1 d",
      },
    ],
    ...
    observations: [
      {
        id: "o-d3-1",
        type: "artefato",
        text: "Novo artefato de pesquisa publicado em Panorama SaaS LATAM.",
        actor: "Marina Reis",
        timeAgo: "há 4 h",
      },
      {
        id: "o-d3-2",
        type: "fenômeno",
        text: "Fenômeno de baixa resposta sinalizado pelo observatório.",
        actor: "ObiOne · IA",
        timeAgo: "há 1 d",
      },
    ],
  ...
  d4: {
    ...
    type: "Gerencial",
    status: "ativo",
    objective: "Observar a coerência editorial e a continuidade das narrativas em canais digitais.",
    ...
    observations: [
      {
        id: "o-d4-1",
        type: "vínculo",
        text: "Projeto Lançamento Orion vinculado ao domínio.",
        actor: "Pedro Almeida",
        timeAgo: "há 2 h",
      },
      {
        id: "o-d4-2",
        type: "insight",
        text: "Insight de volatilidade editorial gerado.",
        actor: "ObiOne · IA",
        timeAgo: "há 7 h",
      },
    ],
  ...
  d5: {
    ...
    type: "Gerencial",
    status: "em-revisão",
    objective: "Observar a relação entre operação comercial e direcionamento estratégico.",
    ...
    observations: [
      {
        id: "o-d5-1",
        type: "artefato",
        text: "Funil comercial Helix atualizado.",
        actor: "Júlia Santos",
        timeAgo: "há 9 h",
      },
    ],
  ...
  d6: {
    ...
    type: "Acadêmico",
    status: "em-formação",
    objective: "Acompanhar a maturação de iniciativas de pesquisa aplicada e ensino.",
    ...
    observations: [
      {
        id: "o-d6-1",
        type: "vínculo",
        text: "Domínio configurado para observação contínua.",
        actor: "ObiOne · IA",
        timeAgo: "há 2 d",
      },
    ],
